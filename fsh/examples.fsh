...
* identifier.type = http://build.fhir.org/v2/0203/index.html#MR
...
* vaccineCode = CVX#08 "Hep B Pediatric"
...
* patient = Reference(ImmDSPatientExample)
* date = "2020-05-26"
* recommendation[0].vaccineCode = CVX#45 "HepB"
...
* recommendation[2].vaccineCode = CVX#17 "Hib"
...
* recommendation[4].vaccineCode = CVX#33 "Pneumococcal"
...
* recommendation[5].vaccineCode = CVX#122 "Rotavirus"
